...
class MarketPlacePagee extends StatefulWidget {
  const MarketPlacePagee({super.key});
  static String routeNameM = "/market2";

  @override
  State<MarketPlacePagee> createState() => _MarketPlacePageState();
}

class _MarketPlacePageState extends State<MarketPlacePagee> {
  ...
  Future<void> fetchCropData() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://10.0.2.2:5000/api/crops?location=$selectedLocation'),
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 8,
                children: [
                  'Akola', 'Nagpur', 'Amravati', 'Wardha', 'Yavatmal', 'Buldhana','Pune'
